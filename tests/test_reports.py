...
from src.reports import read_xlsx_financial_operations, average_spending_by_day_type

EXAMPLE_DATA = [
    {'Дата операции': '01.01.2024 12:00:00', 'Категория': 'Shopping', 'Кэшбэк': '5', 'Сумма операции': '100.0', 'Описание': 'Clothes'},
    {'Дата операции': '02.01.2024 14:30:00', 'Категория': 'Food', 'Кэшбэк': '2', 'Сумма операции': '50.0', 'Описание': 'Groceries'},
    {'Дата операции': '03.01.2024 18:00:00', 'Категория': 'Transport', 'Кэшбэк': '0', 'Сумма операции': '20.0', 'Описание': 'Bus Ticket'},
]
